...
def knn_example_tests():
    ...
    # should be "low"
    low_image1 = RGBImage(create_random_pixels(0, 75, 300, 300))
    low_image2 = RGBImage(create_random_pixels(64, 180, 300, 300))
    high_image1 = RGBImage(create_random_pixels(180, 255, 300, 300))
    high_image2 = RGBImage(create_random_pixels(200, 255, 300, 300))


    if knn.predict(low_image1) == "low":
        print("Low Test #1 successful")
    else:
        print("Low Test #1 unsuccessful")
    
    if knn.predict(low_image2) == "low":
        print("Low Test #2 successful")
    else:
        print("Low Test #2 unsuccessful")
    
    if knn.predict(high_image1) == "high":
        print("High Test #1 successful")
    else:
        print("High Test #1 unsuccessful")

    if knn.predict(high_image2) == "high":
        print("High Test #2 successful")
    else:
        print("High Test #2 unsuccessful")
